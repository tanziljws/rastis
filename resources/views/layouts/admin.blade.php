            ...
            <div class="col-md-3 col-lg-2 px-0">
                <div class="sidebar">
                    <div class="p-3 text-center">
                        <div class="mb-3">
                            <img src="{{ asset('images/logo-smkn4-bogor.png') }}" alt="SMK NEGERI 4 KOTA BOGOR" class="img-fluid" style="max-height: 100px; width: auto; background: transparent; padding: 0;">
                        </div>
